...
/**
 * Full-screen loading animation shown for a few seconds when the site opens
 * and on every route change: Nano Spark logo at the centre with the tagline,
 * concentric gold circles radiating outward, and a progress bar.
...
export default function Preloader() {
  return (
    <motion.div
      className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-nsBlack"
      initial={{ opacity: 1 }}
      exit={{ opacity: 0 }}
