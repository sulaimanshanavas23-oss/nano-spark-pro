...
/** Nano Spark e-commerce store — buy kits and components online. */
const STORE_URL = 'https://steamkit.vercel.app?_vercel_share=7ukv0YU8P7vDTkteRArd7b5GBy0Sn411'
...
export default function Products() {
  return (
    <Page>
      ...
      {/* ============ ONLINE STORE ============ */}
      <section className="relative overflow-hidden bg-nsBlack py-16">
        <CircuitBackground variant="dark" className="opacity-60" />
        <div className="relative mx-auto max-w-6xl px-6 sm:px-8">
          <Reveal>
            <div className="flex flex-col items-center justify-between gap-8 lg:flex-row">
              <div className="text-center lg:text-left">
                <span className="section-heading-bullet justify-center lg:justify-start">
                  <span className="text-nsYellow">&#9654;</span> Nano Spark Online Store
                </span>
                <h2 className="mt-3 font-heading text-3xl font-extrabold text-white sm:text-4xl">
                  Buy kits &amp; components <span className="text-nsYellow">online</span>
                </h2>
                <p className="mx-auto mt-3 max-w-xl text-nsWhite/70 lg:mx-0">
                  Order STEM kits, Arduino boards, sensors, motors and every component you need
                  directly from the Nano Spark e-commerce store — delivered to your doorstep.
                </p>
              </div>
              <a
                href={STORE_URL}
              ...
              >
                Shop Kits &amp; Components <FiExternalLink />
              </a>
            </div>
          </Reveal>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 sm:px-8 lg:grid-cols-2">
          <Reveal>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                Shop Kits &amp; Components Online <FiExternalLink />
              </a>
            </div>
          </Reveal>
